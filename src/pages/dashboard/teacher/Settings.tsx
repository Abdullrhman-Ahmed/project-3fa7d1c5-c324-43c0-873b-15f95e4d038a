          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input defaultValue="أ. محمد أحمد" disabled />
              </div>
              <div className="space-y-2">
                <Label>البريد الإلكتروني</Label>
                <Input defaultValue="m.ahmed@weschools.edu" disabled />
              </div>
              <div className="space-y-2">
                <Label>رقم الهاتف</Label>
                <Input defaultValue="01098765432" />
              </div>
              <div className="space-y-2">
                ...
                <Input defaultValue="الرياضيات" disabled />
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">إشعار عند تقييم طالب</p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">إشعار بغياب الطلاب</p>
                </div>
                <Switch defaultChecked />
              </div>
              <div className="flex items-center justify-between">
